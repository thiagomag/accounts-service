...
import br.com.thiagomagdalena.accountsservice.infrastructure.persistence.repository.AddressRepository;
...
public class AddressRepositoryGateway implements AddressGateway {
    ...
    @Override
    public Set<AddressEntity> findByUserId(Long userId) {
